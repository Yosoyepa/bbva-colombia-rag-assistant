...
from src.application.ports.embedding_cache_repository import EmbeddingCacheRepository
...
from src.application.ports.scraped_page_repository import ScrapedPageRepository
